...
import { useUpateProductMutation } from '../../redux/api/productsApi';
...
const UpdateProduct = () => {
    ...
    const [updateProduct, { isLoading, isSuccess, error }] = useUpateProductMutation();
        ...
        <form className="shadow rounded bg-body" onSubmit={submitHandler}>
          ...
          <div className="row">
            <div className="mb-3 col">
              ...
              <select className="form-select" id="category_field" 
              name="category"
              value={category}
              onChange={onChange}>
